	...
	<header class="d-flex flex-wrap justify-content-between py-3">
		...
		<div class="collapse navbar-collapse text-center" id="navbarNav">
			<ul class="navbar-nav d-lg-none">
				<li class="nav-item"><a href="../../../index.php" class="nav-link text-white" aria-current="page" style="color:#c61c1c;">Accueil</a></li>
				<li class="nav-item"><a href="../association.php" class="nav-link text-white" style="color:#c61c1c;">Association</a></li>
				<li class="nav-item"><a href="../tournoi.php" class="nav-link text-white" style="color:#c61c1c;">Tournoi</a></li>
				<li class="nav-item"><a href="../jeux.php" class="nav-link text-white" style="color:#c61c1c;">Jeux</a>
				</li>
				<li class="nav-item"><a href="../formulaire.php" class="nav-link text-white" style="color:#c61c1c;">Inscription</a></li>
			</ul>
		</div>
	</header>
