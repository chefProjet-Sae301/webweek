...
<body>
	...
	<section class="debut-tournoi">
		...
		<p class="tournoi-text">A l’approche de Noël, un petit tournoi des 1000 sabords, il n’y a rien de mieux pour s’amuser en famille.</p>
		<p class="tournoi-text">Inscrivez-vous avec votre mère, votre père, votre frère, votre soeur et tentez ensemble d’être premier au classement.</p>
	</section>
				...
				<div class="col-sm-6 col-md-6 col-lg-6 mb-3 justify-content-center d-none d-sm-flex">
					<div class="card" style="width: 20rem;">
						...
						<div class="card-body">
							...
							<p class="card-text">Le trésor se gagne aux dés, venez défiez d’autre pirate au cours de ce tournoi sérieux. Choisissez votre équipier de guerre et venez ! Oserez-vous miser le risque, ou jouerez vous la sécurité ?</p>
