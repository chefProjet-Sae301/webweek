    ...
    <main>
        ...
        <div class="container-tab">
            ...
            <div class="image-container-tab">
                <img src="public/img/stand.webp" alt="Description de l'image">
            </div>
        </div>
        <div class="flex-container">
            ...
            <div class="text-container-bj">
                ...
                <p>La bourse des jeux aura lieu le samedi 14 et le dimanche 15 Décembre. Si vous avez des jeux à vendre, n’hésitez pas à venir, c’est un moment convivial, pour faire découvrir à d’autres personnes de nouveaux moyens de s’amuser.
                    ...
                    <br><br> Le temps des chimères va vous aider pour ce Noël.</p>
                <button class="boutton-LJ">Découvrez la liste des jeux</button>
            </div>
        </div>
        <div class="flex-container-tournoi">
            <div class="text-container-tournoi">
                ...
                <button class="boutton-tournoi">Découvrez le tournoi</button>
            </div>
        ...
        <div class="container-tableau">
            ...
            <table id="table1">
            <tr><td class="cellule">1</td></tr>
                <tr><td class="cellule">2</td></tr>
                <tr><td class="cellule">3</td></tr>
                <tr><td class="cellule">4</td></tr>
                <tr><td class="cellule">5</td></tr>
                <tr><td class="cellule">6</td></tr>
                <tr><td class="cellule">7</td></tr>
            </table>
        ...
        <button class="boutton-tournoi2">Découvrez le tournoi</button>
    </main>
    <footer>
        <article>
