	...
	<main>
		...
		<div class="container-tab">
			<div class="tab-container">
				...
				<div class="table-acceuil">
					<button class="tablinks" id="defaultOpen" onclick="openTab(event, 'BourseAuxJeux')">Bourse aux jeux</button>
				...
				<div id="BourseAuxJeux" class="tabcontent">
					<p>La bourse des jeux aura lieu le samedi 14 et le dimanche 15 Décembre au Centre Pierre Cardinal. Si vous avez des jeux à vendre, n’hésitez pas à venir, c’est un moment convivial, pour faire découvrir à d’autres personnes de nouveaux moyens de s’amuser.</p>
				</div>

				<div id="Tournoi" class="tabcontent">
					<p>Un tournoi de mille sabords sera également présent. Deux catégories seront disponibles, une pour jouer sérieusement et l’autre pour se défier en famille. Alors n’hésitez plus, après tout le trésor se gagne aux dés.</p>
				</div>

				<div id="Association" class="tabcontent">
					<p>Le Temps des Chimères est une association qui organise chaque année un salon du jeu (accueillant 1000 personnes). Nous proposons également d’autres événements autour du jeu à notre initiative ou en partenariat avec d’autres structures.</p>
				</div>
			</div>
		...
		<div class="flex-container">
			...
			<div class="text-container-bj">
				...
				<p>La bourse des jeux aura lieu le samedi 14 et le dimanche 15 Décembre. Si vous avez des jeux à vendre, n’hésitez pas à venir, c’est un moment convivial, pour faire découvrir à d’autres personnes de nouveaux moyens de s’amuser.
					<br><br>Si vous avez pris du retard sur vos cadeaux de Noël, il est l’heure de vous rattraper et d’acheter vos derniers cadeaux !
		...
		<div class="flex-container-tournoi">
			<div class="text-container-tournoi">
				...
				<p>A l’approche de Noël, un petit tournoi de 1000 sabords, il n’y a rien de mieux pour s’amuser en famille.<br><br>

					Inscrivez-vous avec votre mère, votre père, votre frère, votre sœur et tentez ensemble d’être premier au classement.</p>
		...
		<section id="association-galerie">
			...
			<div class="owl-carousel owl-theme">
				<div class="item"><img src="public/img/1.webp" alt="Image de galerie : affiche 2024 d'un évènement de l'association"></div>
				<div class="item"><img src="public/img/2.webp" alt="Image de galerie : affiche 2023 d'un évènement de l'association"></div>
				<div class="item"><img src="public/img/3.webp" alt="Image de galerie : prise lors d'un évènement costumé"></div>
				...
				<div class="item"><img src="public/img/7.webp" alt="Image de galerie : prise lors d'une conférence"></div>
		...
		<div class="container-tableau">
			...
			<table id="table1">
				<tr>
					<td class="cellule">1</td>
				</tr>
				<tr>
					<td class="cellule">2</td>
				</tr>
				<tr>
					<td class="cellule">3</td>
				</tr>
				<tr>
					<td class="cellule">4</td>
				</tr>
				<tr>
					<td class="cellule">5</td>
				</tr>
				<tr>
					<td class="cellule">6</td>
				</tr>
				<tr>
					<td class="cellule">7</td>
				</tr>
			</table>
